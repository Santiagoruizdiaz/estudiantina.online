...
## Mapeo de Skills (16 Skills)

1. `project-context`: Todos los agentes (convenciones, contextos y reglas de Estudiantina.online).
2. `estudiantina-posadas-domain`: `fullstack-orchestrator`, `product-requirements`, `domain-architect`, `backend-application`, `frontend-architect`, `ui-ux`, `qa-test`.
3. `software-architecture`: `fullstack-orchestrator`, `software-architect`, `code-review`, `migration-refactoring`.
4. `typescript-reliability`: `fullstack-orchestrator`, `software-architect`, `backend-application`, `frontend-architect`, `integration-specialist`, `code-review`.
5. `nextjs-architecture`: `backend-application`, `frontend-architect`.
6. `prisma-postgres`: `database-prisma`, `performance-engineer`.
7. `auth-security`: `auth-policy`, `security-review`.
8. `ui-system`: `frontend-architect`, `ui-ux`, `accessibility-specialist`.
9. `testing-quality`: `qa-test`.
10. `devops-cicd`: `devops`.
11. `integrations`: `integration-specialist`.
12. `async-systems`: `async-jobs-engineer`.
13. `observability`: `observability-engineer`.
14. `performance`: `performance-engineer`.
15. `release-engineering`: `fullstack-orchestrator`, `release-manager`, `devops`.
16. `creador-de-agentes`: `fullstack-orchestrator`, `devops`.
