...
function guardarDatos($dataFile, $datos) {
    ...
    return @file_put_contents($dataFile, $json, LOCK_EX);
}
...
if ($method === "POST") {
    ...
    if ($action === "registrarEgresado") {
        ...
        $nuevoRegistro = [
            "id" => "global_" . round(microtime(true) * 1000) . "_" . rand(100, 999),
            "nombre" => $nombre,
            "apodoJugador" => $apodo,
            "colegioId" => $colegioId,
